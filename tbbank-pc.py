...
def play_sound_from_url(url):
    # Lưu âm thanh tạm thời từ URL
    response = requests.get(url)
    with open("temp.mp3", "wb") as f:
        f.write(response.content)

    # Phát âm thanh từ file tạm
    playsound("temp.mp3")
...
try:
    ...
    print("{do}⚠️ Không tìm thấy file LAMDev.txt, sẽ bắt đầu từ đầu.")

print("\033[34m🔄 Đang theo dõi giao dịch mới...")
